          ...
          <div className="flex items-center gap-2.5">
            ...
            <div className="relative">
              <button
                ...
                onKeyDown={e => { if (e.key === 'Escape') setModeDropdownOpen(false); }}
                aria-expanded={modeDropdownOpen}
                aria-haspopup="listbox"
                aria-label={t('discoverProjects')}
              ...
              {modeDropdownOpen && (
                <>
                  ...
                  <div role="listbox" aria-label={t('discoverProjects')} className="absolute top-full right-0 mt-1 z-50 bg-white rounded-lg shadow-lg border border-[#e5e7eb] overflow-hidden min-w-[180px]">
